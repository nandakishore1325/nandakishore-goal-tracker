 ...
 */
async function createInboxItem(userId, message) {
    const inboxItem = {
        userId,
        source: 'slack',
...
async function handleAppMention(event) {
    ...
    const slackData = (_a = firstUserDoc.data().integrations) === null || _a === void 0 ? void 0 : _a.slack;
    if (!(slackData === null || slackData === void 0 ? void 0 : slackData.accessToken)) {
        console.log('No access token found');
        return;
    }
    const client = new web_api_1.WebClient(slackData.accessToken);
...
async function handleMessage(event) {
    ...
    for (const slackUserId of mentionedUserIds) {
        ...
        const slackData = (_b = (_a = userDoc.data()) === null || _a === void 0 ? void 0 : _a.integrations) === null || _b === void 0 ? void 0 : _b.slack;
        if (!(slackData === null || slackData === void 0 ? void 0 : slackData.accessToken)) {
            continue;
        }
        const client = new web_api_1.WebClient(slackData.accessToken);
